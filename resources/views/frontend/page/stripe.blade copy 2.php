...
<script type="text/javascript">
    ...
    //                     },
    //                 },
    //                 return_url: '{{ route('checkout.success') }}' // URL to redirect after payment
    ...
    //             var errorElement = document.getElementById('ideal-errors');
    //             errorElement.textContent = 'Payment request failed: ' + error.message;
    //         });
    //     } else {
    //         // Handle card payment
        ...
        fetch('{{ route('checkout.createIntent') }}', {
            ...
            stripe.confirmIdealPayment(client_secret, {
                ...
                if (result.error) {
                    ...
                    // Payment successful, redirect to the payment handler (which should create the order)
                    window.location.href = '{{ route('checkout.success') }}';
                }
            });
        }).catch(function(error) {
